    ...
    pub fn scan_token(&mut self) -> Result<Token, LexerError> {
        ...
        if let Some(c) = self.source_iterator.next() {
            ...
            return match c {
                ...
                _ => Err(LexerError::UndefinedToken {
                    line: self.line,
...
mod test {
    ...
    fn test_binary_operand(token_type: TokenType, lexeme: &str) {
        ...
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::Number, "1")
        );
        assert_eq!(lexer.scan_token(), make_token_line_1(token_type, lexeme));
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::Number, "2")
        );
    ...
    fn single_character_tokens() {
        ...
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::LeftParenthesis, "(")
        );
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::RightParenthesis, ")")
        );
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::LeftBrace, "{")
        );
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::RightBrace, "}")
        );
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::LeftBracket, "[")
        );
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::RightBracket, "]")
        );
        assert_eq!(lexer.scan_token(), make_token_line_1(TokenType::Comma, ","));
        assert_eq!(lexer.scan_token(), make_token_line_1(TokenType::Dot, "."));
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::Semicolon, ";")
        );
        assert_eq!(lexer.scan_token(), make_token_line_1(TokenType::Colon, ":"));
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::Question, "?")
        );
        assert_eq!(lexer.scan_token(), make_token_line_1(TokenType::Eof, ""));
    ...
    fn literals() {
        ...
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::Identifier, "variable1")
        );
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::Identifier, "variable2")
        );
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::Number, "5")
        );
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::Identifier, "kebab")
        );
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::Identifier, "chef")
        );
        assert_eq!(lexer.scan_token(), make_token_line_1(TokenType::Eof, ""));
        ...
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::String, "kebab")
        );
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::String, "chef")
        );
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::Identifier, "makes")
        );
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::Identifier, "food")
        );
        assert_eq!(lexer.scan_token(), make_token_line_1(TokenType::Eof, ""));
    }
    ...
    fn keywords() {
        ...
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::Break, "break")
        );
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::Class, "class")
        );
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::Else, "else")
        );
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::Extends, "extends")
        );
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::False, "false")
        );
        assert_eq!(lexer.scan_token(), make_token_line_1(TokenType::For, "for"));
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::Func, "func")
        );
        ...
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::Return, "return")
        );
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::Static, "static")
        );
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::Super, "super")
        );
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::This, "this")
        );
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::True, "true")
        );
        assert_eq!(lexer.scan_token(), make_token_line_1(TokenType::Var, "var"));
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::While, "while")
        );
        assert_eq!(lexer.scan_token(), make_token_line_1(TokenType::Eof, ""));
    }
    ...
    fn single_line_comment() {
        ...
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::Identifier, "number1")
        );
    ...
    fn multi_line() {
        ...
        assert_eq!(
            lexer.scan_token(),
            make_token_line_2(TokenType::Identifier, "number2")
        );
        assert_eq!(lexer.scan_token(), make_token_line_2(TokenType::Equal, "="));
        assert_eq!(
            lexer.scan_token(),
            make_token_line_2(TokenType::Number, "4")
        );
        assert_eq!(lexer.scan_token(), make_token_line_2(TokenType::Slash, "/"));
        assert_eq!(
            lexer.scan_token(),
            make_token_line_2(TokenType::Number, "2")
        );
        assert_eq!(
            lexer.scan_token(),
            make_token_line_2(TokenType::Semicolon, ";")
        );
    ...
    fn multi_line_with_single_line_comment() {
        ...
        assert_eq!(
            lexer.scan_token(),
            make_token_line_3(TokenType::Identifier, "number2")
        );
        assert_eq!(lexer.scan_token(), make_token_line_3(TokenType::Equal, "="));
        assert_eq!(
            lexer.scan_token(),
            make_token_line_3(TokenType::Number, "4")
        );
        assert_eq!(lexer.scan_token(), make_token_line_3(TokenType::Slash, "/"));
        assert_eq!(
            lexer.scan_token(),
            make_token_line_3(TokenType::Number, "2")
        );
        assert_eq!(
            lexer.scan_token(),
            make_token_line_3(TokenType::Semicolon, ";")
        );
        assert_eq!(lexer.scan_token(), make_token_line_3(TokenType::Eof, ""));

        let code =
            String::from("var number1 = 1 + 2;\t\t\t   // This is a comment\nvar number2 = 4 / 2;");
        let mut lexer = Lexer::new(&code);
        assert_eq!(lexer.scan_token(), make_token_line_1(TokenType::Var, "var"));
        assert_eq!(
            lexer.scan_token(),
    ...
    fn mutli_line_with_mulitline_comment() {
        ...
        assert_eq!(
            lexer.scan_token(),
            make_token(TokenType::Identifier, "number2", 5)
        );
    ...
    fn detects_incomplete_multi_line_comment() {
        ...
        assert_eq!(
            lexer.scan_token(),
            Err(LexerError::IncompleteComment { line: 4 })
        );
    ...
    fn detects_incomplete_string() {
        ...
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::Identifier, "s")
        );
        assert_eq!(lexer.scan_token(), make_token_line_1(TokenType::Equal, "="));
        assert_eq!(
            lexer.scan_token(),
            Err(LexerError::IncompleteString { line: 1 })
        );
    }
    ...
    fn function_body() {
        ...
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::Identifier, "main")
        );
        assert_eq!(
            lexer.scan_token(),
            make_token_line_1(TokenType::LeftParenthesis, "(")
